...
DATA_PATH = "/root/llm/churn_data_regulated.parquet"
...
st.title("TeleCommunication Customer Churn Project")

def main():
    model = load_model()
    data = load_data()

    X_train = load_x_y("/root/llm/X_train.pkl")
    X_test = load_x_y("/root/llm/X_test.pkl")
    y_train = load_x_y("/root/llm/y_train.pkl")
    y_test = load_x_y("/root/llm/y_test.pkl")
